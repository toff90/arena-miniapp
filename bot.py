"""
🔥 Arena Bot v8.0 – Webhook stabile, tutti gli handler inclusi
- Singolo processo: Flask nel main thread, bot in thread separato
- Webhook impostato automaticamente all'avvio
- Nessun polling, nessun conflitto
- Testato e funzionante su Render
"""
